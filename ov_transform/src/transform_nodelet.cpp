...
// void OvtransformNodeletClass::setupTransformationMatrix(std::shared_ptr<ov_core::YamlParser> parser){
...
// Eigen::Matrix<double, 7, 1> OvtransformNodeletClass::print_tf(Eigen::Matrix4d T) {
...
void OvtransformNodeletClass::odomCallback(const nav_msgs::Odometry& msg_in){
  ROS_INFO("Get into odom CAll Back!!");
...
void OvtransformNodeletClass::onInit()
{
  ...
  //std::string config_path = "/home/chenyu/Desktop/ws_openvins/src/open_/home/chenyu/Desktop/ws_openvins/src/open_vins/ov_msckf/../config/zed_minivins/ov_msckf/../config/zed_mini/estimator_config.yaml";
...
//   ROS_INFO("<<<OvtransformNodeletClass Constructor");
  ...
  //auto trans_cal= ov_transform::Transform_calculator(nh, parser);
  // trans_cal.setup();
  // sub_odomimu = nh.subscribe("/OvmsckfNodeletClass_loader/odomimu", 1, &OvtransformNodeletClass::odomCallback, this, ros::TransportHints().tcpNoDelay());
  //setupTransformationMatrix(parser);
  ROS_INFO("<<<<<<>>>>>  Setup");
  sub_odomimu = nh.subscribe("/OvmsckfNodeletClass_loader/odomimu", 100, &OvtransformNodeletClass::odomCallback, this, ros::TransportHints().tcpNoDelay());
  ...
  ROS_INFO("line 39 OvtransformNodeletClass Constructor>>>");
}
...
PLUGINLIB_EXPORT_CLASS(ovtransform_nodelet_ns::OvtransformNodeletClass, nodelet::Nodelet)
